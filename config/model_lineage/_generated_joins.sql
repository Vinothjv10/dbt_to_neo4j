...
SELECT
  ...
  t.premise_id,  -- t2_hub_outscan_wise_awb_level_details.premise_id
  t.hub,  -- t2_hub_outscan_wise_awb_level_details.hub
  t.type,  -- t2_hub_outscan_wise_awb_level_details.type
  t.cp_id,  -- t2_hub_outscan_wise_awb_level_details.cp_id
  t.channel_partner,  -- t2_hub_outscan_wise_awb_level_details.channel_partner
  t.shipments_outscanned,  -- t2_hub_outscan_wise_awb_level_details.awb_number
  t.shipments_inscanned_on_same_day,  -- t2_hub_outscan_wise_awb_level_details.same_cp_same_day_inscan_count
  t.shipments_not_inscanned_on_same_day,  -- t2_hub_outscan_wise_awb_level_details.same_cp_same_day_inscan_count
  t.shipments_ofd_on_same_day,  -- t2_hub_outscan_wise_awb_level_details.same_cp_same_day_ofd_count
  t.shipments_rto_ofd_on_same_day,  -- t2_hub_outscan_wise_awb_level_details.same_cp_same_day_rto_ofd_count
  t.shipments_delivered_on_same_day,  -- t2_hub_outscan_wise_awb_level_details.same_cp_same_day_delivered_count
  t.shipments_rto_delivered_on_same_day,  -- t2_hub_outscan_wise_awb_level_details.same_cp_same_day_rto_delivered_count
  t.shipments_rto_initiated_on_same_day,  -- t2_hub_outscan_wise_awb_level_details.same_cp_same_day_rto_initiated_count
  t.shipments_undelivered_on_same_day,  -- t2_hub_outscan_wise_awb_level_details.same_cp_same_day_undelivered_count
  t.shipments_rto_undelivered_on_same_day,  -- t2_hub_outscan_wise_awb_level_details.same_cp_same_day_rto_undelivered_count
  t.ndd,  -- t2_hub_outscan_wise_awb_level_details.same_cp_next_day_delivered_count
  t.ndd_plus_1,  -- t2_hub_outscan_wise_awb_level_details.same_cp_d_plus_2_delivered_count
  t.ndd_plus_2,  -- t2_hub_outscan_wise_awb_level_details.same_cp_d_plus_3_delivered_count
  t.ndd_plus_3,  -- t2_hub_outscan_wise_awb_level_details.same_cp_d_plus_4_delivered_count
  t.ndd_plus_4,  -- t2_hub_outscan_wise_awb_level_details.same_cp_d_plus_5_delivered_count
  t.ndd_greater_4  -- t2_hub_outscan_wise_awb_level_details.same_cp_d_greater_5_delivered_count
...
LEFT JOIN silver_layer.t2_hub_outscan_wise_awb_level_details t2_hub_outscan_wise_
  ON
    ...
    t.premise_id = t2_hub_outscan_wise_.premise_id AND
    t.hub = t2_hub_outscan_wise_.hub AND
    t.type = t2_hub_outscan_wise_.type AND
    t.cp_id = t2_hub_outscan_wise_.cp_id AND
    t.channel_partner = t2_hub_outscan_wise_.channel_partner AND
    t.shipments_outscanned = t2_hub_outscan_wise_.awb_number AND
    t.shipments_inscanned_on_same_day = t2_hub_outscan_wise_.same_cp_same_day_inscan_count AND
    t.shipments_not_inscanned_on_same_day = t2_hub_outscan_wise_.same_cp_same_day_inscan_count AND
    t.shipments_ofd_on_same_day = t2_hub_outscan_wise_.same_cp_same_day_ofd_count AND
    t.shipments_rto_ofd_on_same_day = t2_hub_outscan_wise_.same_cp_same_day_rto_ofd_count AND
    t.shipments_delivered_on_same_day = t2_hub_outscan_wise_.same_cp_same_day_delivered_count AND
    t.shipments_rto_delivered_on_same_day = t2_hub_outscan_wise_.same_cp_same_day_rto_delivered_count AND
    t.shipments_rto_initiated_on_same_day = t2_hub_outscan_wise_.same_cp_same_day_rto_initiated_count AND
    t.shipments_undelivered_on_same_day = t2_hub_outscan_wise_.same_cp_same_day_undelivered_count AND
    t.shipments_rto_undelivered_on_same_day = t2_hub_outscan_wise_.same_cp_same_day_rto_undelivered_count AND
    t.ndd = t2_hub_outscan_wise_.same_cp_next_day_delivered_count AND
    t.ndd_plus_1 = t2_hub_outscan_wise_.same_cp_d_plus_2_delivered_count AND
    t.ndd_plus_2 = t2_hub_outscan_wise_.same_cp_d_plus_3_delivered_count AND
    t.ndd_plus_3 = t2_hub_outscan_wise_.same_cp_d_plus_4_delivered_count AND
    t.ndd_plus_4 = t2_hub_outscan_wise_.same_cp_d_plus_5_delivered_count AND
    t.ndd_greater_4 = t2_hub_outscan_wise_.same_cp_d_greater_5_delivered_count
